...
class ChatClient:
    ...
    def send_chat(self):
        ...
        message = (senders_name + data).encode('utf_8')
        self.chat_transcript_area.insert('end',message.decode('utf_8') + '\n')
    ...
    def listen_thread(self):
        ...
        t = Thread(target = self.receive_message,args = (self.client_sock,))
        t.start()
